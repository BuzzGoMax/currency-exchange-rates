[Currency Exchange Rates](https://apify.com/fatihai-tools/currency-exchange-rates?fpr=data)
...
![Currency Exchange Data Scraper - XE Alternative avatar](https://apify.com/img/store/actor_picture.svg)

Currency Exchange Data Scraper - XE Alternative

Pricing

Pay per usage

[Try for free](https://console.apify.com/actors/0PoKqI6cUBxPwnmyK?addFromActorId=0PoKqI6cUBxPwnmyK)[Go to Apify Store](https://apify.com/store)![Currency Exchange Data Scraper - XE Alternative](https://apify.com/img/store/actor_picture.svg)

# Currency Exchange Data Scraper - XE Alternative

[Try for free](https://console.apify.com/actors/0PoKqI6cUBxPwnmyK?addFromActorId=0PoKqI6cUBxPwnmyK)

Scrape data from Currency Exchange fast. Bulk URL or query input, structured JSON/CSV output, no login required. Free trial — perfect alternative to XE, OANDA. Use for lead generation, market research, competitive analysis.
...
[README](https://apify.com/fatihai-tools/currency-exchange-rates)[Input](https://apify.com/fatihai-tools/currency-exchange-rates/input-schema)[Pricing](https://apify.com/fatihai-tools/currency-exchange-rates/pricing)[API](https://apify.com/fatihai-tools/currency-exchange-rates/api/python)[Issues](https://apify.com/fatihai-tools/currency-exchange-rates/issues/open)

The Actor has no **README.md** file. Sad!

## You might also like

[### Google Reviews Data Scraper - Trustpilot scraper Alternative
...
2](https://apify.com/fatihai-tools/realtor-scraper)[### LinkedIn Profile Data Scraper - Apollo Alternative

fatihai-tools / linkedin-profile-scraper

Scrape profile data from LinkedIn fast. Bulk URL or query input, structured JSON/CSV output, no login required. Free trial — perfect alternative to Apollo, Sales Navigator. Use for lead generation, market research, competitive analysis.

![User avatar](https://images.apifyusercontent.com/3hqpkgYhriHguznw66rIW11nfPTLFOJ1VQLgxuDwM-M/rs:fill:32:32/cb:.webp)

fatih dağüstü

21](https://apify.com/fatihai-tools/linkedin-profile-scraper)[### Craigslist Data Scraper - Facebook Marketplace Alternative
